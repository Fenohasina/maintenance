...
<html lang="en">
	<head>
		...
		<!-- <link href="<?php echo base_url('assets/css/int_custom.css') ?>" rel="stylesheet"> -->
		<!-- <link href="<?php echo base_url('assets/css/orig_custom.css') ?>" rel="stylesheet"> -->
		<!-- /Import CSS -->
	</head>
	<body class="nav-md">
			...
			<div class="main_container">
				...
				<footer>
					<div class="pull-right">
						&copy; Tous droits réservés - <a href="https://colorlib.com">Direction Générale des Impôts</a> || SSIF || 2018 || version 0.1 alpha
					</div>
			        <div class="clearfix"></div>
				</footer>
				<!-- /Footer Content -->
		...
		<script src="<?php echo base_url('vendors/pdfmake/build/vfs_fonts.js') ?>"></script>
			<!-- Custom JS -->
		<script src="<?php echo base_url('assets/js/custom/debounce.js') ?>"></script>
		<script src="<?php echo base_url('assets/js/custom/sidebar.js') ?>"></script>
		<script src="<?php echo base_url('assets/js/custom/nprogress.js') ?>"></script>
