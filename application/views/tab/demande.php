            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="col-md-9 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Date de la demande</label>
                            <div class="col-md-4 col-sm-4 col-xs-12 xdisplay_inputx form-group has-feedback">
                                <input id="date_demande" type="text" class="form-control has-feedback-left" placeholder="JJ/MM/AAAA" readonly="readonly">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-2 col-sm-4 col-xs-12">
                                    <input type="checkbox" class="js-switch" checked readonly="readonly">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group col-md-6 col-sm-4 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Ex: 00000001" readonly="readonly">
                                </div>
                            </div>
                        </div>
